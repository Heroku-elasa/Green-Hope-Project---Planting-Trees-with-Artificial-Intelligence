...
const App: React.FC = () => {
    ...
    const renderPage = () => {
        switch (page) {
            ...
            case 'video': return <VideoGenerator onGenerateScript={handleGenerateScript} scenes={videoScenes} isScriptLoading={isScriptLoading} error={error} videoPrompt={videoPrompt} setVideoPrompt={setVideoPrompt} videoDuration={videoDuration} setVideoDuration={setVideoDuration} videoAspectRatio={videoAspectRatio} setVideoAspectRatio={setVideoAspectRatio} onConfirmScene={onConfirmScene} onGenerateSceneVideo={handleGenerateSceneVideo} onGenerateSceneImage={handleGenerateSceneImage} onGenerateMusic={onGenerateMusic} videoMusicPrompt={videoMusicPrompt} setVideoMusicPrompt={setVideoMusicPrompt} videoMusicDescription={videoMusicDescription} isMusicLoading={isMusicLoading} selectedMusicUrl={selectedMusicUrl} setSelectedMusicUrl={setSelectedMusicUrl} videoType={videoType} setVideoType={setVideoType} />;
