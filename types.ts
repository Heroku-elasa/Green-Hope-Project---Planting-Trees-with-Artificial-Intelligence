  ...
  en: {
    ...
    compostingPage: {
        ...
        aiAssistant: {
            ...
            visionUploadButton: "Upload a file",
            visionDragAndDrop: "or drag and drop",
            visionFileTypeInfo: "PNG, JPG, WEBP up to 10MB",
  ...
  fa: {
    ...
    compostingPage: {
        ...
        aiAssistant: {
            ...
            visionUploadButton: "یک فایل آپلود کنید",
            visionDragAndDrop: "یا بکشید و رها کنید",
            visionFileTypeInfo: "PNG, JPG, WEBP تا ۱۰ مگابایت",
